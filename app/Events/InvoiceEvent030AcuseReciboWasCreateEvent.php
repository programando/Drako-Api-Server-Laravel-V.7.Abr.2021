...
class InvoiceEvent030AcuseReciboWasCreateEvent
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    public $Factura, $FileXml, $FilePdf, $PathPdf, $PathXml, $ZipPathFile, $ZipFile, $UUID, $EventNumber, $EventId ;

    public function __construct( $Factura, $EventNumber, $EventId )  {
